      ...
      <div className="list-of-bikes">
        ...
        <aside className="list-of-bikes">
          {loading ? (
            ...
            <div className="welcome-message">You must be logged in to create and view your bikes.<br /> If you do not have an account, please <a href="/register">register</a> to login.</div>
          )}
          <hr />
        </aside>
      </div>
