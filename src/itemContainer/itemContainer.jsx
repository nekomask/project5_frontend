...
const ItemContainer = (props) => {
    ...
    const createNewItem = async (newItem) => {
        ...
        const apiResponse = await fetch("http://mybikedatabase-frontend.herokuapp.com/items", {
            method: "POST",
    ...
    const deleteItem = async (idToDelete) => {
        ...
        try {
            const apiResponse = await fetch(`http://mybikedatabase-frontend.herokuapp.com/items/${idToDelete}`, {
                method: "DELETE"
            })
            const parsedResponse = await apiResponse.json()
            if (parsedResponse.success) {
        ...
        const getItems = async () => {
            try {
                const items = await fetch("http://mybikedatabase-frontend.herokuapp.com/items")
        ...
        const updateItem = async (idToUpdate, itemToUpdate) => {
            ...
            const apiResponse = await fetch(`http://mybikedatabase-frontend.herokuapp.com/items/${idToUpdate}`, {
