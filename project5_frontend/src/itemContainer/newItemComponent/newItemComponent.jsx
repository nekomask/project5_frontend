                        ...
                        <form onSubmit={submitNewItem}>
                            ...
                            <div className="frame_and_fork">
                                ...
                                <ul className="frame_and_fork">
                                    ...
                                    <li><a href="https://www.sheldonbrown.com/rinard/forklengths.htm" target="_blank"><img src="./images/icons/question_icon.png"/></a> Fork Length: <input onChange={handleInputChange} type="text" name="forkLength" placeholder="Suspension, Rigid, ect." value={newItem.forkLength || ""} /></li><hr /><br />
                                    ...
                                    <li> <a href="https://canecreek.com/everything-you-need-to-know-about-headsets/#elementor-toc__heading-anchor-4" target="_blank"><img src="./images/icons/question_icon.png"/></a> Headtube Type: <input onChange={handleInputChange} type="number" name="headTubeType" placeholder="Press-fit, Integrated" value={newItem.headTubeType} /></li><hr /><br />
